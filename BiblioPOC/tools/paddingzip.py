...
def do_zip_mod(input_data, prepend_str, append_str):
    manipulation = ZIPManipulation(input_data, prepend_str.encode(), append_str.encode()) # .jar\n../../mods/\nprivate\n#pgx0\n
    return manipulation.run()